...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // webhooks_github
        if ($pathinfo === '/webhooks/github') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_webhooks_github;
            }

            return array (  '_controller' => 'AppBundle\\Controller\\WebhookController::githubAction',  '_route' => 'webhooks_github',);
        }
        not_webhooks_github:
