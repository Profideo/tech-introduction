...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.github.cached_labels_api' => 'getApp_Github_CachedLabelsApiService',
            'app.github.client' => 'getApp_Github_ClientService',
            'app.github.issues_api' => 'getApp_Github_IssuesApiService',
            'app.github.labels_api' => 'getApp_Github_LabelsApiService',
            'app.github.request_handler' => 'getApp_Github_RequestHandlerService',
            'app.repository_provider' => 'getApp_RepositoryProviderService',
            'app.status_api' => 'getApp_StatusApiService',
            'app.subscriber.auto_label_pr_from_content_subscriber' => 'getApp_Subscriber_AutoLabelPrFromContentSubscriberService',
            'app.subscriber.bug_label_new_issue_subscriber' => 'getApp_Subscriber_BugLabelNewIssueSubscriberService',
            'app.subscriber.needs_review_new_pr_subscriber' => 'getApp_Subscriber_NeedsReviewNewPrSubscriberService',
            'app.subscriber.status_change_by_comment_subscriber' => 'getApp_Subscriber_StatusChangeByCommentSubscriberService',
            'app.subscriber.status_change_on_push_subscriber' => 'getApp_Subscriber_StatusChangeOnPushSubscriberService',
    ...
    /**
     * Gets the public 'app.github.cached_labels_api' shared service.
     *
     * @return \AppBundle\Issues\GitHub\CachedLabelsApi
     */
    protected function getApp_Github_CachedLabelsApiService()
    {
        return $this->services['app.github.cached_labels_api'] = new \AppBundle\Issues\GitHub\CachedLabelsApi($this->get('app.github.labels_api'));
    }

    /**
     * Gets the public 'app.github.client' shared service.
     *
     * @return \Github\Client
     */
    protected function getApp_Github_ClientService()
    {
        $this->services['app.github.client'] = $instance = new \Github\Client();

        $instance->authenticate('http_token', 'dd6f9f7f-07d0-4887-baaf-56db62b470b9');

        return $instance;
    }

    /**
     * Gets the public 'app.github.issues_api' shared service.
     *
     * @return \Github\Api\Issue
     */
    protected function getApp_Github_IssuesApiService()
    {
        return $this->services['app.github.issues_api'] = $this->get('app.github.client')->api('issue');
    }

    /**
     * Gets the public 'app.github.labels_api' shared service.
     *
     * @return \Github\Api\Issue\Labels
     */
    protected function getApp_Github_LabelsApiService()
    {
        return $this->services['app.github.labels_api'] = $this->get('app.github.issues_api')->labels();
    }

    /**
     * Gets the public 'app.github.request_handler' shared service.
     *
     * @return \AppBundle\Issues\GitHubRequestHandler
     */
    protected function getApp_Github_RequestHandlerService()
    {
        return $this->services['app.github.request_handler'] = new \AppBundle\Issues\GitHubRequestHandler($this->get('debug.event_dispatcher'), $this->get('app.repository_provider'), $this, $this->get('logger'));
    }

    /**
     * Gets the public 'app.repository_provider' shared service.
     *
     * @return \AppBundle\Repository\Provider\InMemoryRepositoryProvider
     */
    protected function getApp_RepositoryProviderService()
    {
        return $this->services['app.repository_provider'] = new \AppBundle\Repository\Provider\InMemoryRepositoryProvider(array('profideo/sdk' => array('subscribers' => array(0 => 'app.subscriber.status_change_by_comment_subscriber', 1 => 'app.subscriber.needs_review_new_pr_subscriber', 2 => 'app.subscriber.bug_label_new_issue_subscriber', 3 => 'app.subscriber.auto_label_pr_from_content_subscriber')), 'symfony/symfony-docs' => array('subscribers' => array(0 => 'app.subscriber.status_change_by_comment_subscriber', 1 => 'app.subscriber.status_change_on_push_subscriber', 2 => 'app.subscriber.needs_review_new_pr_subscriber', 3 => 'app.subscriber.bug_label_new_issue_subscriber', 4 => 'app.subscriber.auto_label_pr_from_content_subscriber')), 'weaverryan/symfony' => array('subscribers' => array(0 => 'app.subscriber.status_change_by_comment_subscriber', 1 => 'app.subscriber.status_change_on_push_subscriber', 2 => 'app.subscriber.needs_review_new_pr_subscriber', 3 => 'app.subscriber.bug_label_new_issue_subscriber', 4 => 'app.subscriber.auto_label_pr_from_content_subscriber'))));
    }

    /**
     * Gets the public 'app.status_api' shared service.
     *
     * @return \AppBundle\Issues\GitHub\GitHubStatusApi
     */
    protected function getApp_StatusApiService()
    {
        return $this->services['app.status_api'] = new \AppBundle\Issues\GitHub\GitHubStatusApi($this->get('app.github.cached_labels_api'), $this->get('logger'));
    }

    /**
     * Gets the public 'app.subscriber.auto_label_pr_from_content_subscriber' shared service.
     *
     * @return \AppBundle\Subscriber\AutoLabelPRFromContentSubscriber
     */
    protected function getApp_Subscriber_AutoLabelPrFromContentSubscriberService()
    {
        return $this->services['app.subscriber.auto_label_pr_from_content_subscriber'] = new \AppBundle\Subscriber\AutoLabelPRFromContentSubscriber($this->get('app.github.cached_labels_api'));
    }

    /**
     * Gets the public 'app.subscriber.bug_label_new_issue_subscriber' shared service.
     *
     * @return \AppBundle\Subscriber\BugLabelNewIssueSubscriber
     */
    protected function getApp_Subscriber_BugLabelNewIssueSubscriberService()
    {
        return $this->services['app.subscriber.bug_label_new_issue_subscriber'] = new \AppBundle\Subscriber\BugLabelNewIssueSubscriber($this->get('app.status_api'));
    }

    /**
     * Gets the public 'app.subscriber.needs_review_new_pr_subscriber' shared service.
     *
     * @return \AppBundle\Subscriber\NeedsReviewNewPRSubscriber
     */
    protected function getApp_Subscriber_NeedsReviewNewPrSubscriberService()
    {
        return $this->services['app.subscriber.needs_review_new_pr_subscriber'] = new \AppBundle\Subscriber\NeedsReviewNewPRSubscriber($this->get('app.status_api'));
    }

    /**
     * Gets the public 'app.subscriber.status_change_by_comment_subscriber' shared service.
     *
     * @return \AppBundle\Subscriber\StatusChangeByCommentSubscriber
     */
    protected function getApp_Subscriber_StatusChangeByCommentSubscriberService()
    {
        return $this->services['app.subscriber.status_change_by_comment_subscriber'] = new \AppBundle\Subscriber\StatusChangeByCommentSubscriber($this->get('app.status_api'), $this->get('logger'));
    }

    /**
     * Gets the public 'app.subscriber.status_change_on_push_subscriber' shared service.
     *
     * @return \AppBundle\Subscriber\StatusChangeOnPushSubscriber
     */
    protected function getApp_Subscriber_StatusChangeOnPushSubscriberService()
    {
        return $this->services['app.subscriber.status_change_on_push_subscriber'] = new \AppBundle\Subscriber\StatusChangeOnPushSubscriber($this->get('app.status_api'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'phpmyadmin.dev', 'port' => NULL, 'dbname' => 'githook', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9e6b654d70febd14ef047ead66778465f7942da80d5092167de02306c9f3a317');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ae54dae2def9.43924977')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'phpmyadmin.dev',
            'database_port' => NULL,
            'database_name' => 'githook',
            'database_user' => 'root',
            ...
            'github_token' => 'dd6f9f7f-07d0-4887-baaf-56db62b470b9',
            'symfony_docs_secret' => 'XX',
            'repositories' => array(
                'profideo/sdk' => array(
                    'subscribers' => array(
                        0 => 'app.subscriber.status_change_by_comment_subscriber',
                        1 => 'app.subscriber.needs_review_new_pr_subscriber',
                        2 => 'app.subscriber.bug_label_new_issue_subscriber',
                        3 => 'app.subscriber.auto_label_pr_from_content_subscriber',
                    ),
                ),
                'symfony/symfony-docs' => array(
                    'subscribers' => array(
                        0 => 'app.subscriber.status_change_by_comment_subscriber',
                        1 => 'app.subscriber.status_change_on_push_subscriber',
                        2 => 'app.subscriber.needs_review_new_pr_subscriber',
                        3 => 'app.subscriber.bug_label_new_issue_subscriber',
                        4 => 'app.subscriber.auto_label_pr_from_content_subscriber',
                    ),
                ),
                'weaverryan/symfony' => array(
                    'subscribers' => array(
                        0 => 'app.subscriber.status_change_by_comment_subscriber',
                        1 => 'app.subscriber.status_change_on_push_subscriber',
                        2 => 'app.subscriber.needs_review_new_pr_subscriber',
